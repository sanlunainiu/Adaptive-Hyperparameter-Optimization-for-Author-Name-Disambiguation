...
import sys
sys.path.append(r"C:\Users\Jason Burne\Desktop\original_code_result")
import os
import time
...
def load_test_names():
    return load_json(settings.DATA_DIR, 'test_name_list_mini.json')


def main():
    names = load_test_names()
    wf = codecs.open(join(settings.OUT_DIR, 'local_clustering_results_mini.csv'), 'w', encoding='utf-8')
