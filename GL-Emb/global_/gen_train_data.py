"""
We are executing the code on a Windows system, therefore, 
we put the commented code below in global_\triplets_generator.py to avoid potential errors.
"""

from global_.triplets_generator import TripletsGenerator
...
#         self.names_train = list(self.name2pubs_train.keys())
#         print('names train', len(self.names_train))
#         self.names_test = list(self.name2pubs_test.keys())
