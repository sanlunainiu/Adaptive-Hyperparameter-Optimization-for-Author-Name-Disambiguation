...
from global_.global_model_gpu import GlobalTripletModel
from utils.eval_utils_gpu import get_hidden_output
...
def dump_inter_emb():
    ...
    name_to_pubs_test = data_utils.load_json(settings.GLOBAL_DATA_DIR, 'name_to_patent_test_200.json')
