...
class MetaPathGenerator:
    ...
    def generate_PHNet(self):
        ...
        with open (r"gene\PHNet.pkl",'wb') as file: # or 'gene-citeseerx-kim' file
...
dirpath = r"gene"  # or 'gene-citeseerx-kim' file
outfilename =r"gene\WMRW.txt" #weighted_metapath_random_walk. or 'gene-citeseerx-kim' file
