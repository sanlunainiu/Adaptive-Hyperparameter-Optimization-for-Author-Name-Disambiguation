...
# for 'raw-data' dataset
folder_path = 'gene'
os.makedirs(folder_path, exist_ok=True)
            
f1 = open (r'gene\paper_author.txt','w',encoding = 'utf-8')
f2 = open (r'gene\paper_conf.txt','w',encoding = 'utf-8')
f3 = open (r'gene\paper_word.txt','w',encoding = 'utf-8')

f4 = open (r'gene\paper_author1.txt','w',encoding = 'utf-8')
f5 = open (r'gene\paper_title.txt','w',encoding = 'utf-8')


# for 'raw-data-citeseerx-kim' dataset
# folder_path = 'gene-citeseerx-kim'
# os.makedirs(folder_path, exist_ok=True)              
           
# f1 = open (r'gene-citeseerx-kim\paper_author.txt','w',encoding = 'utf-8')
# f2 = open (r'gene-citeseerx-kim\paper_conf.txt','w',encoding = 'utf-8')
# f3 = open (r'gene-citeseerx-kim\paper_word.txt','w',encoding = 'utf-8')

# f4 = open (r'gene-citeseerx-kim\paper_author1.txt','w',encoding = 'utf-8')
# f5 = open (r'gene-citeseerx-kim\paper_title.txt','w',encoding = 'utf-8')
